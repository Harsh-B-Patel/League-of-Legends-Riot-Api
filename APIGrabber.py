#First we need to import requests. Installing this is a bit tricky. I included a step by step process on how to get requests in readme.md which is included in the file along with this program.
import requests
